...
import { Check, Crosshair, RotateCcw, SkipForward, X } from 'lucide-react'
    ...
    if (!quiz || !result) {
        ...
        return (
            <main className='flex justify-center w-screen h-full items-center bg-transparent p-5'>
                <header className='bg-primary/5 z-50 flex items-center h-16 justify-between rounded-xl top-4 fixed sm:w-[800px] w-[calc(100%-32px)] px-8 border border-primary/10'>
                ...
                >
                    <div className='bg-white/5 mt-8 backdrop-blur-md border border-white/10 rounded-2xl sm:p-8 p-5 shadow-xl sm:w-[560px]'>
